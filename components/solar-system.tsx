...
// Replace the Comet component with this updated version
function Comet({
  orbitSpeed,
  isPaused,
  showLabel,
  ...
  const semiMajorAxis = 80; // Large orbit
  const eccentricity = 0.8; // High eccentricity for elongated orbit
  const semiMinorAxis =
  ...
  // Create comet orbit path
  const orbitPath = useMemo(() => {
    const curve = new THREE.EllipseCurve(
      -focalDistance, // x center offset by focal distance
      0, // y center
      semiMajorAxis,
      semiMinorAxis,
      0,
